...
function RepoDetails() {
  ...
  useEffect(() => {
    fetch(`https://api.github.com/repos/EriboDavid/${id}`)
  ...
  useEffect(() => {
    fetch(`https://api.github.com/repos/EriboDavid/${id}/branches`)
      .then((response) => response.json())
      .then((data) => {
        setBranch(data);
      });
  ...
  useEffect(() => {
    fetch(`https://api.github.com/repos/EriboDavid/${id}/deployments`)
      .then((response) => response.json())
      .then((data) => {
        setDeployment(data);
      });
      ...
      <div className="repodetail-card">
        ...
        <p>
          ...
          {deployment.length === 0 ? (
            ...
            <a href={`https://EriboDavid.github.io/${details.name}`}>
              EriboDavid.github.io/{details.name}
            </a>
          }
        </p>
        <p>
